    ...
    >
      ...
      <aside className="lg:sticky lg:top-6 space-y-4 h-max">
        ...
        <div className="rounded-xl border border-gray-700 bg-gray-800 p-4">
          ...
          <div className="mt-3 text-xs text-gray-400 select-all">
            {goalTemplate}
          </div>
        </div>
      </aside>
      ...
      <section className="space-y-8">
        ...
        {viewMode === 'examples' ? (
            ...
            {PREDEFINED_SCENARIOS.map((scenario) => (
              ...
              >
                <button
                  ...
                  className="w-full px-6 py-4 text-left flex justify-between items-center bg-gray-800 hover:bg-gray-700 transition-colors"
                >
                  ...
                  <div className="px-6 py-4 bg-gray-900">
                    ...
                    <div className="space-y-2">
                      {scenario.steps.map((step, i) => (
                        ...
                        >
                          <div className="font-bold text-blue-400 min-w-[50px]">
                            {step.year}
                          </div>
          ...
          <div>
            ...
            {generatedScenario && (
              <div className="mt-6 p-5 border border-green-800 bg-green-900/20 rounded-xl">
                ...
                <div className="mt-4 space-y-2">
                  {generatedScenario.steps?.map((step, i) => (
                    <div key={i} className="flex gap-2">
                      <span className="font-mono text-green-300">{step.year}:</span>
                      <span className="text-gray-100">{step.description}</span>
                    </div>
                  ))}
                </div>
              </div>
